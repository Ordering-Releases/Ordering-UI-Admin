...
import { OrderingProvider } from 'ordering-components-admin-external'
...
if (!(window?.location?.hostname === 'localhost')) {
  Sentry.init({
    ...
    dsn: "https://5a6646d194bc434f9d2109d3a63ad733@o460529.ingest.sentry.io/6303007",
    integrations: [
      new Integrations.BrowserTracing()
    ],
    release: process.env.npm_package_version ? 'ordering-ui-admin-release@' + process.env.npm_package_version : 'ordering-ui-admin-release@' + '1.3.0',
    // Release health
