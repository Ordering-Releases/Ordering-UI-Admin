...
import { useLanguage, UserMetaFields as UserMetaFieldsController } from 'ordering-components-admin-external'
...
export const UserMetaFields = (props) => {
  ...
  return <UserMetaFieldsController {...MetaFieldsProps} />
}
