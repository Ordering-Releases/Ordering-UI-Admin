...
import { useLanguage, ProductMetaFields as ProductMetaFieldsController } from 'ordering-components-admin-external'
...
const ProductMetaFieldsUI = (props) => {
  const {
    businessId,
    categoryId,
    productId,
...
export const ProductMetaFields = (props) => {
  ...
  return <ProductMetaFieldsController {...MetaFieldsProps} />
}
