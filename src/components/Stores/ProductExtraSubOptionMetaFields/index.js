...
const ProductExtraSubOptionMetaFieldsUI = (props) => {
  const {
    businessId,
    extraId,
    optionId,
...
export const ProductExtraSubOptionMetaFields = (props) => {
  const MetaFieldsProps = {
    ...props,
    asDashboard: true,
    UIComponent: ProductExtraSubOptionMetaFieldsUI
  }
  return <ProductExtraSubOptionMetaFieldsController {...MetaFieldsProps} />
}
