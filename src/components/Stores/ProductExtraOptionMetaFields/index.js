...
import { useLanguage, ProductExtraOptionMetaFields as ProductExtraOptionMetaFieldsController } from 'ordering-components-admin-external'
...
export const ProductExtraOptionMetaFields = (props) => {
  const MetaFieldsProps = {
    ...props,
    asDashboard: true,
    UIComponent: ProductExtraOptionMetaFieldsUI
  }
  return <ProductExtraOptionMetaFieldsController {...MetaFieldsProps} />
}
