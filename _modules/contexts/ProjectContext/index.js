...
exports.ProjectProvider = exports.ProjectContext = void 0;
 ...
 */
var ProjectContext = exports.ProjectContext = /*#__PURE__*/(0, _react.createContext)();

/**
  * Custom provider to mange shared info
  * @param {props} props
  */
var ProjectProvider = exports.ProjectProvider = function ProjectProvider(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 6;
            return fetch("".concat(ordering.root, "/current"), {
              method: 'GET',
              headers: {
  ...
  return /*#__PURE__*/_react.default.createElement(ProjectContext.Provider, {
    value: [state, functions]
  }, children);
};
function useProjectState() {
  var projectManager = _react.default.useContext(ProjectContext);
  return projectManager || [{}, function () {}];
}