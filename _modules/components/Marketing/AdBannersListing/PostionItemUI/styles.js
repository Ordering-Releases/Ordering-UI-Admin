...
exports.TitleContainer = exports.Title = exports.ItemContent = exports.ItemContainer = exports.IconWrapper = exports.Description = void 0;
...
var ItemContainer = exports.ItemContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  cursor: pointer;\n  display: flex;\n  flex-direction: row;\n  margin: 15px 0;\n  padding: 20px 10px;\n  transition: all 0.3s;\n  border-radius: 8px;\n  cursor: pointer;\n  border: 1px solid transparent;\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background: #E9F2FE;\n  }\n\n  @media (max-width: 576px) {\n    flex-direction: column;\n  }\n"])), function (_ref) {
...
var ItemContent = exports.ItemContent = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
...
var Description = exports.Description = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  font-weight: normal;\n  font-size: 12px;\n  color: #909BA9;\n\n  @media (min-width: 577px) {\n    display: -webkit-box;\n    -webkit-box-orient: vertical;\n    -webkit-line-clamp: 2;\n    overflow: hidden;\n  }\n"])));