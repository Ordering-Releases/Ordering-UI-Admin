...
var CategoryTreeNode = function CategoryTreeNode(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, ((_subCategoriesList$fi = subCategoriesList.find(function (_category) {
  ...
  })) === null || _subCategoriesList$fi === void 0 ? void 0 : (_subCategoriesList$fi2 = _subCategoriesList$fi.productIds) === null || _subCategoriesList$fi2 === void 0 ? void 0 : _subCategoriesList$fi2.length) > 0 && /*#__PURE__*/_react.default.createElement(_styles.AccordionSection, null, /*#__PURE__*/_react.default.createElement(_styles.Accordion, {
    ...
    className: setRotate
  }), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("span", null, category.name)))), /*#__PURE__*/_react.default.createElement(_styles.AccordionContent, {
    ref: content,
    style: {
    ...
    return /*#__PURE__*/_react.default.createElement(_styles.AccordionItem, {
      ...
      margin: 20 * (index + 1),
      isProduct: true
    }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_styles.RadioButton, {
      ref: checkboxRef,
      onClick: function onClick() {
        return handleClickProduct(product);
      }
    }, selectedCategoryId === (product === null || product === void 0 ? void 0 : product.category_id) && selectedProductId === (product === null || product === void 0 ? void 0 : product.id) ? /*#__PURE__*/_react.default.createElement(_reactBootstrapIcons.RecordCircleFill, {
...
var SelectBusinessProductsUI = function SelectBusinessProductsUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var iterateCategories = function iterateCategories(categories) {
      return (categories === null || categories === void 0 ? void 0 : categories.length) > 0 && (categories === null || categories === void 0 ? void 0 : categories.forEach(function (category) {
        var _category$products, _category$subcategori2;
        var productIds = [];
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.Container, null, businessState !== null && businessState !== void 0 && businessState.loading ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, _toConsumableArray(Array(10).keys()).map(function (i) {
