...
exports.HeaderRightContainer = exports.HeaderLeftContainer = exports.HeaderContainer = exports.DriversGroupsListingContainer = void 0;
...
var DriversGroupsListingContainer = exports.DriversGroupsListingContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  flex: 1;\n  box-sizing: border-box;\n  transition: all 0.5s;\n  max-height: 100vh;\n  overflow: auto;\n"])));
...
var HeaderRightContainer = exports.HeaderRightContainer = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 20px;\n\n  > *:not(:last-child) {\n    ", "\n  }\n\n  input {\n    background: ", ";\n    border: none;\n  }\n\n  button {\n    height: 41px;\n  }\n\n  @media (min-width: 768px) {\n    margin-top: 0px;\n  }\n"])), function (props) {
  var _props$theme3;
