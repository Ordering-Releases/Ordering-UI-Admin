...
var GroupsContainer = exports.GroupsContainer = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  height: calc(100% - 130px);\n  overflow: auto;\n  max-height: 460px;\n"])));
var GroupWrapper = exports.GroupWrapper = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 12px 0;\n  border-bottom: 1px solid ", ";\n\n  p {\n    margin: 0px;\n    font-size: 14px;\n    ", "\n  }\n\n  ", "\n"])), function (props) {
  ...
  return isDisabed && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});