...
var CurrencyFilterUI = function CurrencyFilterUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!countriesState.loading) {
      var _groupsOption = countriesState.countries.map(function (country) {
        return {
          value: country.code,
          content: /*#__PURE__*/_react.default.createElement(_styles.Option, null, country.code)
        };
      });
...
var CurrencyFilter = function CurrencyFilter(props) {
