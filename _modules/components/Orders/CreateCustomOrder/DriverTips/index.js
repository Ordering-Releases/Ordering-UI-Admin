...
var DriverTipsUI = function DriverTipsUI(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles2.DriverTipContainer, {
    id: "driver-tip-container"
  }, /*#__PURE__*/_react.default.createElement("h3", null, t('DRIVER_TIPS', 'Driver Tips')), /*#__PURE__*/_react.default.createElement("p", null, t('100%_OF_THE_TIP_YOUR_DRIVER', '100% of the tip goes to your driver')), /*#__PURE__*/_react.default.createElement(_styles2.WrapperTips, null, driverTipsOptions.map(function (option, i) {
    return /*#__PURE__*/_react.default.createElement(_styles2.TipCard, {
      key: i,
  ...
  }), isDriverTipUseCustom && /*#__PURE__*/_react.default.createElement(_styles2.TipCard, {
    className: "".concat(customTip ? 'active' : ''),
    onClick: function onClick() {
      return setCustomTip(true);
    }
  }, t('CUSTOM_TIP', 'Custom')), /*#__PURE__*/_react.default.createElement(_styles2.FormDriverTip, null, customTip && /*#__PURE__*/_react.default.createElement(_styles2.WrapperInput, null, /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "drivertip",
    type: "text",
    value: value,
...
var DriverTips = exports.DriverTips = function DriverTips(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsAdminExternal.DriverTips, driverTipsProps);
};