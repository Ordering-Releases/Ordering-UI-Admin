...
exports.StatusBarContainer = exports.StatusBar = exports.SkeletonWrapper = exports.RejectReasonsList = exports.RejectReasonsContainer = exports.RejectReasonWrapper = exports.PlaceSpotContainer = exports.OrderStatusTime = exports.OrderStatusSelectorWrapper = exports.OrderStatus = exports.OrderProducts = exports.OrderDetailsExtraContent = exports.OrderDetailsContent = exports.FormControl = exports.ErrorMessage = exports.DetailBottom = exports.Container = exports.CloseButtonWrapper = exports.ChatContainer = exports.ButtonLink = exports.AssigmentCommentContainer = exports.AdvancedLogistic = void 0;
...
var OrderStatus = exports.OrderStatus = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  margin: ", ";\n\n  h2 {\n    color: ", ";\n    margin: 0px;\n    font-size: 16px;\n  }\n\n  p {\n    color: ", ";\n    font-size: 14px;\n    margin: 0px;\n  }\n\n\n  ", "\n\n  @media (min-width: 768px) {\n    flex-direction: row;\n    align-items: center;\n    justify-content: ", ";\n  }\n"])), function (_ref4) {
  ...
  var flexEnd = _ref6.flexEnd;
  return flexEnd ? 'flex-end' : 'space-between';
});
...
var FormControl = exports.FormControl = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  label {\n    margin-bottom: 10px;\n    font-size: 14px;\n  }\n  textarea {\n    width: 100%;\n  }\n  ", "\n"])), function (_ref7) {
  var isError = _ref7.isError;
...
var AssigmentCommentContainer = exports.AssigmentCommentContainer = _styledComponents.default.form(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  button {\n    width: 100%;\n    border-radius: 8px;\n    height: 44px;\n    margin-top: 30px;\n  }\n"])));
var ErrorMessage = exports.ErrorMessage = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-size: 14px;\n"])), function (props) {
  return props.theme.colors.danger;
});
var OrderStatusTime = exports.OrderStatusTime = _styledComponents.default.div(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n\n"])));