...
var ProductActionsDelete = (0, _styledComponents.default)(ProductActionsEdit)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: none;\n  svg {\n    margin-right: 0px;\n  }\n\n  @media (min-width: 411px){\n    display: block;\n  }\n"])));
exports.ProductActionsDelete = ProductActionsDelete;
var ProductPriceSection = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n"])));
...
var ProductSelect = _styledComponents.default.select(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  max-width: 55px;\n  height: 50px;\n  border: 0;\n  background-color: transparent;\n  font-size: 17px;\n  outline: none;\n  margin-left: 5px;\n\n  ", "\n"])), function (props) {
  var _props$theme7;
...
var ProductNotAvailable = _styledComponents.default.span(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  color: #D81212;\n"])));
exports.ProductNotAvailable = ProductNotAvailable;
var ProductOptionsList = _styledComponents.default.ul(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  list-style-type: none;\n\n  .suboption {\n    margin-left: -25px;\n    ", "\n  }\n\n  p:nth-child(1) {\n    margin-bottom: 0;\n  }\n\n  p {\n    font-weight: 400;\n    margin: 0px;\n    color: ", ";\n    font-size: 12px;\n  }\n\n  li span {\n    color: ", ";\n    font-size: 12px;\n  }\n\n  li.ingredient {\n    padding-left: 15px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme8;
...
var ProductQuantity = _styledComponents.default.span(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  p {\n    margin: 0px 5px;\n  }\n  margin: 0 10px 0 20px;\n\n  ", "\n"])), function (props) {
  var _props$theme10;
...
var ScheduleInfoWrapper = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  width: calc(100% - 65px);\n  box-sizing: border-box;\n  h3 {\n    margin: 0px;\n    font-size: 14px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    color: ", ";\n  }\n  padding-left: 10px;\n  ", "\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n    padding-left: 0px;\n    padding-right: 10px;\n  "])));
});
exports.ScheduleInfoWrapper = ScheduleInfoWrapper;
var ScheduleInfo = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  span {\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 15px;\n  }\n"])));
