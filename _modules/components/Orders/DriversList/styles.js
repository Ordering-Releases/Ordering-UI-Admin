...
var DriverInfo = exports.DriverInfo = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  width: 100%;\n  flex: 1;\n  ", "\n  > div:first-child {\n    display: flex;\n    align-items: center;\n\n    svg {\n      margin: 0 5px;\n    }\n\n    p.name {\n      font-size: 14px;\n      color: ", ";\n      font-weight: 600;\n      margin: 0px;\n      flex: 1;\n    }\n    .text-red {\n      font-size: 14px;\n      color: red;\n      ", "\n    }\n  }\n"])), function (_ref3) {
  var hidePhoto = _ref3.hidePhoto;
  return !hidePhoto && (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n    ", "\n  "])), function (props) {
    var _props$theme;
...
var Timestatus = exports.Timestatus = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  width: 4px;\n  height: 42px;\n  border-radius: 20px;\n  margin-right: 10px;\n  ", "\n ", "\n  ", "\n  ", "\n"])), function (props) {
  var _props$theme3;
  ...
  return timeState === 'in_time' && (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    background-color: #00D27A;\n  "])));
}, function (_ref5) {
  var timeState = _ref5.timeState;
  return timeState === 'at_risk' && (0, _styledComponents.css)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n    background-color: #FFC700;\n  "])));
}, function (_ref6) {
  var timeState = _ref6.timeState;
  return timeState === 'delayed' && (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n    background-color: #E63757;\n  "])));
});