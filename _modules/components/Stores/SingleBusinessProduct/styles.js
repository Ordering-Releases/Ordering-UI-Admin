...
var BusinessGeneralInfo = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  align-items: center;\n  ", "\n  p {\n    margin: 0;\n  }\n  div.product_name {\n    flex: 1;\n    font-weight: 500;\n    font-size: 14px;\n    color: ", ";\n    margin: 0 10px;\n    white-space: nowrap;\n  }\n"])), function (props) {
  var _props$theme;
...
var BusinessEnableWrapper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var UploadWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  border-radius: 5px;\n  background: ", ";\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  svg {\n    color: white;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
exports.UploadWrapper = UploadWrapper;
var DragableContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));
exports.DragableContainer = DragableContainer;
var DragImageWrapper = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  ", "\n\n  img {\n    &:hover {\n      cursor: grab;\n    }\n  }\n"])), function (props) {
  var _props$theme4;
