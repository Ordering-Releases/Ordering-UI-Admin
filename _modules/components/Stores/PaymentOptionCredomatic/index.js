...
exports.PaymentOptionCredomatic = void 0;
...
var PaymentOptionCredomatic = function PaymentOptionCredomatic(props) {
  var _localState$sites, _businessPaymethod$si, _sitesState$sites2, _changesState$data, _changesState$data2, _businessPaymethod$da, _changesState$data3, _changesState$data4, _businessPaymethod$da2, _changesState$data5, _changesState$data6, _businessPaymethod$da3, _changesState$data_sa, _changesState$data_sa2, _businessPaymethod$da4, _changesState$data_sa3, _changesState$data_sa4, _businessPaymethod$da5, _changesState$sandbox, _sitesState$sites3;
  var open = props.open,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles2.Container, {
    id: "credomatic"
  }, /*#__PURE__*/_react.default.createElement(_styles2.Header, null, /*#__PURE__*/_react.default.createElement("h1", null, t('CREDOMATIC', 'Credomatic')), /*#__PURE__*/_react.default.createElement(_styles2.ActionSelectorWrapper, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.DropdownButton, {
  ...
  }, t('ORDER_TYPE', 'Order type'))), /*#__PURE__*/_react.default.createElement(_styles2.BodyContainer, null, paymentTabs === 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles2.FieldName, null, t('PROCESSOR_ID', 'Processor ID')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "processor_id",
    defaultValue: changesState !== null && changesState !== void 0 && (_changesState$data = changesState.data) !== null && _changesState$data !== void 0 && _changesState$data.processor_id ? changesState === null || changesState === void 0 || (_changesState$data2 = changesState.data) === null || _changesState$data2 === void 0 ? void 0 : _changesState$data2.processor_id : businessPaymethod === null || businessPaymethod === void 0 || (_businessPaymethod$da = businessPaymethod.data) === null || _businessPaymethod$da === void 0 ? void 0 : _businessPaymethod$da.processor_id,
    placeholder: t('PROCESSOR_ID', 'Processor ID'),
    onChange: function onChange(e) {
      return handleChangeInput(e, false);
    }
  }), /*#__PURE__*/_react.default.createElement(_styles2.FieldName, null, t('PRIVATE_PRODUCTION_KEY', 'Private Production Key')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "private_production_key",
    defaultValue: changesState !== null && changesState !== void 0 && (_changesState$data3 = changesState.data) !== null && _changesState$data3 !== void 0 && _changesState$data3.private_production_key ? changesState === null || changesState === void 0 || (_changesState$data4 = changesState.data) === null || _changesState$data4 === void 0 ? void 0 : _changesState$data4.private_production_key : businessPaymethod === null || businessPaymethod === void 0 || (_businessPaymethod$da2 = businessPaymethod.data) === null || _businessPaymethod$da2 === void 0 ? void 0 : _businessPaymethod$da2.private_production_key,
    placeholder: t('PRIVATE_PRODUCTION_KEY', 'Private Production Key'),
    onChange: function onChange(e) {
      return handleChangeInput(e, false);
    }
  }), /*#__PURE__*/_react.default.createElement(_styles2.FieldName, null, t('PUBLIC_PRODUCTION_KEY', 'Public Production Key')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "public_production_key",
    defaultValue: changesState !== null && changesState !== void 0 && (_changesState$data5 = changesState.data) !== null && _changesState$data5 !== void 0 && _changesState$data5.public_production_key ? changesState === null || changesState === void 0 || (_changesState$data6 = changesState.data) === null || _changesState$data6 === void 0 ? void 0 : _changesState$data6.public_production_key : businessPaymethod === null || businessPaymethod === void 0 || (_businessPaymethod$da3 = businessPaymethod.data) === null || _businessPaymethod$da3 === void 0 ? void 0 : _businessPaymethod$da3.public_production_key,
    placeholder: t('PUBLIC_PRODUCTION_KEY', 'Public Production Key'),
    onChange: function onChange(e) {
      return handleChangeInput(e, false);
    }
  }), /*#__PURE__*/_react.default.createElement(_styles2.FieldName, null, t('PRIVATE_SANDBOX_KEY', 'Private Sandbox Key')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "private_sandbox_key",
    defaultValue: changesState !== null && changesState !== void 0 && (_changesState$data_sa = changesState.data_sandbox) !== null && _changesState$data_sa !== void 0 && _changesState$data_sa.private_sandbox_key ? changesState === null || changesState === void 0 || (_changesState$data_sa2 = changesState.data_sandbox) === null || _changesState$data_sa2 === void 0 ? void 0 : _changesState$data_sa2.private_sandbox_key : businessPaymethod === null || businessPaymethod === void 0 || (_businessPaymethod$da4 = businessPaymethod.data_sandbox) === null || _businessPaymethod$da4 === void 0 ? void 0 : _businessPaymethod$da4.private_sandbox_key,
    placeholder: "".concat(t('PRIVATE_SANDBOX_KEY', 'Private Sandbox Key')),
    onChange: function onChange(e) {
      return handleChangeInput(e, true);
    }
  }), /*#__PURE__*/_react.default.createElement(_styles2.FieldName, null, t('PUBLIC_SANDBOX_KEY', 'Public Sandbox Key')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    name: "public_sandbox_key",
    defaultValue: changesState !== null && changesState !== void 0 && (_changesState$data_sa3 = changesState.data_sandbox) !== null && _changesState$data_sa3 !== void 0 && _changesState$data_sa3.public_sandbox_key ? changesState === null || changesState === void 0 || (_changesState$data_sa4 = changesState.data_sandbox) === null || _changesState$data_sa4 === void 0 ? void 0 : _changesState$data_sa4.public_sandbox_key : businessPaymethod === null || businessPaymethod === void 0 || (_businessPaymethod$da5 = businessPaymethod.data_sandbox) === null || _businessPaymethod$da5 === void 0 ? void 0 : _businessPaymethod$da5.public_sandbox_key,
    placeholder: "".concat(t('PUBLIC_SANDBOX_KEY', 'Public Sandbox Key'), ")"),
    onChange: function onChange(e) {
      return handleChangeInput(e, true);
    }
  }), /*#__PURE__*/_react.default.createElement(_styles2.SandboxWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.Checkbox, {
    checked: (_changesState$sandbox = changesState === null || changesState === void 0 ? void 0 : changesState.sandbox) !== null && _changesState$sandbox !== void 0 ? _changesState$sandbox : businessPaymethod === null || businessPaymethod === void 0 ? void 0 : businessPaymethod.sandbox,
    onChange: function onChange(e) {
      return handleChangeSandbox(e.target.checked);
    }
  }), /*#__PURE__*/_react.default.createElement("span", null, t('SANDBOX_MODE', 'Sandbox Mode')))), paymentTabs === 1 && (sitesState === null || sitesState === void 0 || (_sitesState$sites3 = sitesState.sites) === null || _sitesState$sites3 === void 0 ? void 0 : _sitesState$sites3.length) > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles4.TabOption, {
    key: "all",
    onClick: function onClick() {
...
exports.PaymentOptionCredomatic = PaymentOptionCredomatic;