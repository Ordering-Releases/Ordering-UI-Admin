...
exports.Step = exports.LinkText = exports.LeftHeader = exports.Header = exports.CopyInputWrapper = exports.Container = void 0;
...
var LinkText = exports.LinkText = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  margin-bottom: 23px;\n  a {\n    color: ", ";\n    text-decoration: none;\n    &:hover {\n      text-decoration: underline;\n    }\n  }\n"])), function (props) {
...
var Step = exports.Step = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  margin-bottom: 27px;\n  h3 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin-top: 0;\n    margin-bottom: 12px;\n  }\n  p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 0;\n    margin-bottom: 20px;\n    color: ", ";\n  }\n  img {\n    width: 100%;\n  }\n\n  @media (min-width: 576px) {\n    img {\n      display: block;\n      width: 90%;\n      margin-left: auto;\n      margin-right: auto;\n      margin-bottom: 24px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var CopyInputWrapper = exports.CopyInputWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  input {\n    flex: 1;\n    height: 44px;\n  }\n  button {\n    margin-left: 15px;\n    ", "\n  }\n  ", "\n"])), function (props) {
