...
var Contentheader = exports.Contentheader = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 10px 20px;\n  border-bottom: 1px solid #e9ecef;\n"])));
var HeaderLogo = exports.HeaderLogo = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral([""])));
var HeaderInfo = exports.HeaderInfo = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  border-radius: 50px;\n  border: 1px solid ", ";\n  background: #f8f9fa;\n  flex: 1;\n  margin: 0px 20px;\n\n  @media (min-width: 850px) {\n    margin: 0px 50px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var AddressWrapper = exports.AddressWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 10px 20px;\n  flex: 1;\n\n  svg {\n    min-width: 16px;\n    color: rgb(177, 188, 204);\n    margin-right: 5px;\n    ", "\n  }\n\n  span {\n    font-size: 12px;\n    font-weight: bold;\n    white-space: nowrap;\n  }\n"])), function (props) {
  var _props$theme;
...
var MomentWrapper = exports.MomentWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border-left: 1px solid ", ";\n  border-right: 1px solid ", ";\n  justify-content: center;\n  padding: 10px 20px;\n  max-width: 150px;\n  width: 100%;\n  span {\n    color: #909ba9;\n    font-size: 12px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  return props.theme.colors.borderColor;
});
var OrderTypeWrapper = exports.OrderTypeWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 10px 20px;\n  max-width: 150px;\n  width: 100%;\n  span {\n    color: #909ba9;\n    font-size: 12px;\n  }\n"])));
var CartWrapper = exports.CartWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  color: white;\n  border-radius: 8px;\n  background: #2C7BE5;\n  padding: 5px;\n  height: 35px;\n  margin: 0px 15px;\n  svg {\n    margin-right: 5px;\n    ", "\n  }\n  span {\n    font-size: 12px;\n  }\n"])), function (props) {
  var _props$theme2;
...
var UserWrapper = exports.UserWrapper = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  svg {\n    margin-right: 10px;\n    ", "\n  }\n\n  > div {\n    width: 35px;\n    height: 35px;\n    border-radius: 8px;\n    overflow: hidden;\n    img, svg {\n      width: 100%;\n      height: 100%;\n      object-fit: cover;\n    }\n  }\n"])), function (props) {
  var _props$theme3;
...
var ContentWrapper = exports.ContentWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  padding: 20px;\n"])));
var BusinessInfoContainer = exports.BusinessInfoContainer = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  margin-bottom: 20px;\n  display: flex;\n  flex-direction: column;\n\n  @media (min-width: 700px) {\n    ", "\n  }\n"])), function (_ref9) {
...
var BusinessInfoContent = exports.BusinessInfoContent = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral([""])));
var BusinessInfo = exports.BusinessInfo = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
var BusinessInfoItem = exports.BusinessInfoItem = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  padding-right:5px;\n  ", "\n\n  h2 {\n    font-weight: 500;\n    font-size: 20px;\n    margin: 0 0 10px 0;\n  }\n\n  .type {\n    font-size: 12px;\n    color: ", ";\n    margin: 0 0 5px 0;\n  }\n\n  .preorder-Reviews {\n    span {\n      user-select: none;\n      cursor: pointer;\n      font-size: 12px;\n      color: ", ";\n      text-decoration: underline;\n      &:not(:last-child) {\n        margin-right: 5px;\n        ", "\n      }\n\n      &.dot {\n        font-size: 12px;\n        text-decoration: none;\n        color: #909BA9;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme4;
...
var BusinessDetail = exports.BusinessDetail = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n\n  h5 {\n    font-size: 12px;\n    color: #909BA9;\n    margin: 0 5px 0 0;\n    font-weight: normal;\n    ", "\n\n    span {\n      margin-right: 5px;\n      ", "\n    }\n  }\n\n  .review {\n    color: #909BA9;\n    margin: 0;\n    display: flex;\n    align-items: center;\n\n    svg {\n      font-size: 15px;\n      margin-bottom: 1px;\n      margin-right: 5px;\n      ", "\n    }\n\n    p {\n      font-size: 12px;\n      margin: 0px;\n    }\n  }\n\n  .dot {\n    color: #909BA9;\n    font-size: 12px;\n    margin-right: 5px;\n    ", "\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme7;
...
var WrapperSearch = exports.WrapperSearch = _styledComponents.default.div(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  svg {\n    left: 0px;\n  }\n  input {\n    border-radius: 0px;\n    border: none;\n    border-bottom: 1px solid ", ";\n    padding: 8px;\n    padding-left: 25px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var BusinessContainer = exports.BusinessContainer = _styledComponents.default.div(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  max-height: 250px;\n  height: 230px;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  min-height: 150px;\n  justify-content: center;\n  align-items: flex-end;\n  border-radius: 7.6px;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  h1 {\n    color: #FFF;\n    opacity: 0.5;\n    position: absolute;\n    top: 0;\n    right: 0;\n    margin: 0 10px;\n    padding: 0;\n  }\n\n  @media (min-width: 490px) {\n    justify-content: flex-start;\n  }\n\n  ", "\n"])), function (props) {
...
var BusinessContent = exports.BusinessContent = _styledComponents.default.div(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  border-radius: 10px;\n  margin: 10px;\n  max-height: 124px;\n  width: 124px;\n\n  @media (min-width: 426px) {\n    margin: 25px;\n  }\n"])));
var WrapperBusinessLogo = exports.WrapperBusinessLogo = _styledComponents.default.div(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n  max-width: 124px;\n  max-height: 124px;\n  height: 90px;\n  width: 90px;\n\n  ", "\n"])), function (_ref12) {
...
var BusinessMoreDetail = exports.BusinessMoreDetail = _styledComponents.default.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  top: 30px;\n  right: 30px;\n  position: absolute;\n  min-width: 24px;\n  width: 20px;\n  height: 20px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  cursor: pointer;\n\n  svg {\n    font-size: 20px;\n    color: white;\n  }\n"])));
var BusinessProductContainer = exports.BusinessProductContainer = _styledComponents.default.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n"])));
var BusinessProductListWrapper = exports.BusinessProductListWrapper = _styledComponents.default.div(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 30px;\n\n  @media (min-width: 700px) {\n    width: 70%;\n    ", "\n  }\n"])), function (_ref13) {
...
var BusinessCartWrapper = exports.BusinessCartWrapper = _styledComponents.default.div(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 30px;\n\n  @media (min-width: 700px) {\n    width: 30%;\n    padding-left: 15px;\n    ", "\n    ", "\n  }\n"])), function (props) {
  var _props$theme12;
...
var CategoryWrapper = exports.CategoryWrapper = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  margin-bottom: 20px;\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var Tab = exports.Tab = _styledComponents.default.div(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n  padding: 6px 0;\n  ", "\n  cursor: pointer;\n  color: ", ";\n  white-space: nowrap;\n  font-size: 12px;\n\n  ", "\n\n  ", "\n"])), function (props) {
  var _props$theme13;
...
var CardContainer = exports.CardContainer = _styledComponents.default.div(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  padding: 10px;\n  margin: 10px 0px;\n  border-radius: 7.6px;\n  cursor: pointer;\n  position: relative;\n  border: 1px solid #E9ECEF;\n  box-sizing: border-box;\n\n  background: ", ";\n\n  @media (min-width: 576px) {\n    margin: 10px;\n    width: calc(100% - 40px);\n  }\n\n  ", "\n  ", "\n"])), function (_ref17) {
...
var CardInfo = exports.CardInfo = _styledComponents.default.div(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  max-width: calc(100% - 90px);\n  > * {\n    margin: 3px;\n  }\n\n  h1 {\n    font-size: 12px;\n    font-weight: 500;\n    text-align: left;\n    color: #263238;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  p {\n    color: #909BA9;\n    text-align: left;\n    font-size: 8px;\n    ", "\n\n    display: -webkit-box;\n    -webkit-box-orient: vertical;\n    -webkit-line-clamp: 2;\n    overflow: hidden;\n  }\n\n  span {\n    color: ", ";\n    font-size: 10px;\n  }\n\n  @media (min-width: 1024px) {\n    p {\n      font-size: 10px;\n    }\n\n    span {\n      font-size: 12px;\n    }\n  }\n"])), function (props) {
  var _props$theme16;
...
var PriceWrapper = exports.PriceWrapper = _styledComponents.default.div(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  .off-price {\n    font-size: 10px;\n    color: #909BA9;\n    margin-left: 5px;\n    text-decoration: line-through;\n\n    ", "\n\n    @media (min-width: 1024px) {\n      font-size: 13px;\n    }\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["\n      margin-right: 5px;\n      margin-left: 0;\n    "])));
});
var WrapLogo = exports.WrapLogo = _styledComponents.default.div(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n  max-width: 65px;\n  max-height: 65px;\n  height: 65px;\n  width: 65px;\n  margin-left: 5px;\n  ", "\n"])), function (props) {
  var _props$theme17;
...
var SoldOut = exports.SoldOut = _styledComponents.default.span(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n  font-weight: bold;\n  position: absolute;\n  background: #495057 0% 0% no-repeat padding-box;\n  padding: 3px 6px;\n  top: 5px;\n  border-radius: 2px 0px 0px 2px;\n  right: 0px;\n  color: white;\n  font-size: 10px;\n  ", "\n  &:first-letter {\n    text-transform: uppercase;\n  }\n"])), function (props) {
  var _props$theme18;
...
var BusinessProductList = exports.BusinessProductList = _styledComponents.default.div(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral([""])));
var ProductsListing = exports.ProductsListing = _styledComponents.default.div(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n  margin-bottom: 15px;\n"])));
var WrapAllCategories = exports.WrapAllCategories = _styledComponents.default.div(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["\n  .category-title {\n    display: flex;\n    align-items: center;\n    padding-top: 5px;\n    padding-bottom: 12px;\n    margin-left: 10px;\n    ", "\n\n    img {\n      border-radius: 7.6px;\n      min-width: 30px;\n      min-height: 30px;\n      height: 30px;\n      width: 30px;\n      margin-right: 8px;\n      ", "\n    }\n\n    @media (min-width: 993px) {\n      margin: 0px;\n    }\n  }\n\n  h3 {\n    font-weight: 500;\n    font-size: 18px;\n    color: ", ";\n    margin: 0px 0px 0px 10px;\n    ", "\n\n    @media (min-width: 993px) {\n      margin: 0px;\n    }\n  }\n"])), function (props) {
  var _props$theme19;
...
var BusinessCartContent = exports.BusinessCartContent = _styledComponents.default.div(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral(["\n  background: ", ";\n  padding: 15px;\n  position: relative;\n  margin-bottom: 20px;\n\n  .product.accordion {\n    margin: 0;\n  }\n\n  ", "\n\n  @media (min-width: 768px) {\n    padding: 25px 20px;\n    position: sticky;\n    top: 0;\n  }\n"])), function (props) {
...
var EmptyCart = exports.EmptyCart = _styledComponents.default.div(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral(["\n  .empty-content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    svg {\n      font-size: 35px;\n      color: #B1BCCC;\n      margin-top: 10px;\n    }\n\n    p {\n      font-size: 12px;\n      color: #B1BCCC;\n      margin: 15px 0 0 0;\n    }\n  }\n"])));
var EmptyBtnWrapper = exports.EmptyBtnWrapper = _styledComponents.default.div(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 15px;\n\n  span {\n    font-weight: 500;\n    font-size: 14px;\n    color: ", ";\n  }\n\n  button {\n    color: #748194;\n    background: #F8F9FA;\n    border: 1px solid #F8F9FA;\n    border-radius: 7.6px;\n    height: 35px;\n    font-size: 12px;\n    padding-left: 15px;\n    padding-right: 15px;\n  }\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var MobileHeaderWrapper = exports.MobileHeaderWrapper = _styledComponents.default.div(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  margin: 15px 0px;\n\n  svg {\n    color: #909BA9;\n  }\n"])));
var MobileCartViewWrapper = exports.MobileCartViewWrapper = _styledComponents.default.div(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral(["\n  position: sticky;\n  width: 100%;\n  left: 0;\n  bottom: 0;\n  background-color: white;\n  padding: 10px 20px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n\n  span {\n    font-weight: 500;\n    font-size: 14px;\n  }\n\n  button {\n    height: 35px;\n    border-radius: 7px;\n  }\n"])));