...
var BusinessLogsUI = function BusinessLogsUI(props) {
...
exports.BusinessLogsUI = BusinessLogsUI;
var BusinessLogs = function BusinessLogs(props) {
  var businessLogsProps = _objectSpread(_objectSpread({}, props), {}, {
    UIComponent: BusinessLogsUI
  });
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsAdminExternal.BusinessLogs, businessLogsProps);
};
exports.BusinessLogs = BusinessLogs;