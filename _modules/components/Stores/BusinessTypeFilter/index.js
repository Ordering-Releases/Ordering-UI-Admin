...
var BusinessTypeFilterUI = function BusinessTypeFilterUI(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles2.TypeContainer, {
    id: "container",
    isSkeleton: loading
  }, loading && /*#__PURE__*/_react.default.createElement(_Shared.DragScroll, null, _toConsumableArray(Array(6)).map(function (_, i) {
  ...
  })), !loading && !error && types && types.length > 0 && /*#__PURE__*/_react.default.createElement(_Shared.DragScroll, null, types.map(function (type, i) {
    return type.enabled && /*#__PURE__*/_react.default.createElement(_styles.Button, {
      key: type.id,
