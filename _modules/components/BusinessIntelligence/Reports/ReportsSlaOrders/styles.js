...
var ReportsTableContainer = exports.ReportsTableContainer = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 25px;\n  padding: 20px;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n"])));
var TitleBlock = exports.TitleBlock = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 20px;\n\n  h2 {\n    font-weight: 600;\n    font-size: 12px;\n    margin: 0;\n    text-transform: uppercase;\n  }\n\n  svg {\n    font-size: 16px;\n    color: #212121;\n    cursor: pointer;\n  }\n\n  ", "\n"])), function (_ref) {
  var active = _ref.active;
  return !active && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    svg {\n      cursor: not-allowed;\n    }\n  "])));
});
var ReportsTable = exports.ReportsTable = _styledComponents.default.table(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  min-width: 500px;\n"])));
var Thead = exports.Thead = _styledComponents.default.thead(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  position: sticky;\n  top: 0px;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n\n  tr {\n    th {\n      padding: 12px 5px;\n      font-weight: 500;\n      font-size: 12px;\n      text-transform: uppercase;\n    }\n\n    &:first-child {\n      th {\n        text-align: center;\n      }\n    }\n\n    &:nth-child(2) {\n      th {\n        text-align: center;\n        &:nth-child(3n-1) {\n          border-left: 1px solid ", ";\n        }\n        &:first-child, &:nth-child(2) {\n          border: none;\n        }\n        &:first-child {\n          border-right: 1px solid ", ";\n        }\n      }\n    }\n  }\n"])), function (props) {
...
var Tbody = exports.Tbody = _styledComponents.default.tbody(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n\n  tr {\n    td {\n      padding: 12px 5px;\n      font-size: 12px;\n      text-align: center;\n      color: ", ";\n      white-space: nowrap;\n\n      &:nth-child(3n-1) {\n        border-left: 1px solid ", ";\n      }\n      &:first-child, &:nth-child(2) {\n        color: ", ";\n        border: none;\n      }\n      &:first-child {\n        border-right: 1px solid ", ";\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme9;
...
var Tfoot = exports.Tfoot = _styledComponents.default.tfoot(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  tr {\n    td {\n      font-weight: 500;\n      font-size: 12px;\n      padding: 12px 0;\n\n      &:not(:first-child) {\n        text-align: center;\n      }\n    }\n  }\n"])));
var TableWrapper = exports.TableWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 100%;\n  overflow: auto;\n  max-height: 650px;\n"])));
var EmptyContent = exports.EmptyContent = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 10px;\n"])));
var AnalyticsTimeZoneWrapper = exports.AnalyticsTimeZoneWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  width: 100%;\n  button {\n    margin-top: 5px;\n    background: ", ";\n    border-radius: 7.6px;\n    padding: 7px 15px;\n    font-size: 14px;\n    color: ", ";\n    border: none;\n  }\n\n  @media (min-width: 600px) {\n    width: fit-content;\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
...
var TimeZoneAndCalendar = exports.TimeZoneAndCalendar = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  width: 100%;\n\n  @media (min-width: 600px) {\n    flex-direction: row;\n    width: fit-content;\n  }\n"])));
var BrandBusinessWrapper = exports.BrandBusinessWrapper = (0, _styledComponents.default)(CalendarWrapper)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n\n  > button {\n    margin-right: 10px;\n    margin-left: 0;\n\n  ", "\n  }\n"])), function (props) {
  var _props$theme14;
  return ((_props$theme14 = props.theme) === null || _props$theme14 === void 0 ? void 0 : _props$theme14.rtl) && (0, _styledComponents.css)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n    margin-left: 10px;\n    margin-right: 0;\n  "])));
});