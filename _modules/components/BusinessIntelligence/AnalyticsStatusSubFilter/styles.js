...
exports.SubFilterContainer = exports.SkeletonWrapper = void 0;
...
var SubFilterContainer = exports.SubFilterContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 20px 0;\n  button {\n    margin-top: 5px;\n    margin-bottom: 5px;\n    text-transform: capitalize;\n    ", "\n    font-size: 14px;\n    white-space: nowrap;\n\n    svg {\n      font-size: 20px;\n\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme;
