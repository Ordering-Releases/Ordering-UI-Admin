...
var ReviewsTable = exports.ReviewsTable = _styledComponents.default.table(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin: 10px 0;\n  width: 100%;\n  thead {\n    tr {\n      border-bottom: solid 1px ", ";\n    }\n  }\n\n  th {\n    font-size: 12px;\n    font-weight: 700;\n  }\n\n  th, td {\n    padding: 10px 0;\n  }\n"])), function (props) {
  return props.theme.colors.disabled;
});
var ReviewTbody = exports.ReviewTbody = _styledComponents.default.tbody(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border-bottom: 1px solid ", ";\n  &:hover {\n    background-color: ", ";\n  }\n  ", "\n"])), function (props) {
...
var ReviewObject = exports.ReviewObject = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  display: flex;\n  align-items: center;\n\n  > div:first-child {\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
