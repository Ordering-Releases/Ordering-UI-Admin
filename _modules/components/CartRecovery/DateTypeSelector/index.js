...
var DateTypeSelector = exports.DateTypeSelector = function DateTypeSelector(props) {
  ...
  var handleChangeDates = function handleChangeDates(item) {
    ...
    if ((_item$selection = item.selection) !== null && _item$selection !== void 0 && _item$selection.startDate && (_item$selection2 = item.selection) !== null && _item$selection2 !== void 0 && _item$selection2.endDate) {
      var from = (0, _moment.default)(item.selection.startDate).format('YYYY-MM-DD HH:mm:ss');
      var to = (0, _moment.default)(item.selection.endDate).format('YYYY-MM-DD HH:mm:ss');
