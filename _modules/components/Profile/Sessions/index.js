...
var SessionsUI = exports.SessionsUI = function SessionsUI(props) {
...
var Sessions = exports.Sessions = function Sessions(props) {
  var sessionsProps = _objectSpread(_objectSpread({}, props), {}, {
    UIComponent: SessionsUI
  });
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsAdminExternal.Sessions, sessionsProps);
};