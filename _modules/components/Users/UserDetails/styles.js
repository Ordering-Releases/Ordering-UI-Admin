...
exports.VerifiedItemsWrapper = exports.VerifiedItem = exports.UserName = exports.SavedPlaces = exports.RightHeader = exports.PersonalizationWrapper = exports.OrdersWrapper = exports.DetailsHeader = exports.ActionSelectorWrapper = void 0;
...
var RightHeader = exports.RightHeader = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  ", "\n"])), function (_ref) {
  var isLoginUser = _ref.isLoginUser;
  return isLoginUser && (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    .expand {\n      margin-right: 25px;\n      ", "\n    }\n  "])), function (props) {
    return props.theme.rtl && (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        margin-left: 25px;\n        margin-right: 0;\n      "])));
  });
});
var UserName = exports.UserName = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  > span {\n    font-size: 20px;\n    font-weight: 700;\n    color: ", ";\n    margin: 0;\n  }\n  > label {\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      margin-right: 10px;\n      margin-left: 0px;\n    "])));
});
var VerifiedItem = exports.VerifiedItem = _styledComponents.default.span(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  font-size: 10px;\n  background-color: ", ";\n  padding: 2px 7px;\n  border-radius: 50px;\n  color: ", ";\n  display: flex;\n  align-items: center;\n  margin: 0 5px;\n\n  svg {\n    font-size: 12px;\n    ", "\n  }\n"])), function (props) {
...
var PersonalizationWrapper = exports.PersonalizationWrapper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  height: calc(100% - 60px);\n  > div {\n    padding: 35px 0px 25px;\n  }\n"])));
var OrdersWrapper = exports.OrdersWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  #orderTable {\n    border-top: 1px solid ", ";\n    table {\n      min-width: initial;\n      width: 100%;\n    }\n  }\n"])), function (props) {
...
var VerifiedItemsWrapper = exports.VerifiedItemsWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex: 1;\n"])));