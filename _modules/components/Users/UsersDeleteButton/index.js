...
var UsersDeleteButton = exports.UsersDeleteButton = function UsersDeleteButton(props) {
  ...
  var handleModalOpen = function handleModalOpen() {
    setConfirmAdmin({
      open: true,
      handleOnConfirm: function handleOnConfirm(code) {
  ...
  }, t('DELETE', 'Delete')), /*#__PURE__*/_react.default.createElement(_Shared.ConfirmAdmin, {
