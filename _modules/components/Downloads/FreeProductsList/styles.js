...
var FreeProductsListContainer = exports.FreeProductsListContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  flex: 1;\n  padding: 25px 20px;\n  box-sizing: border-box;\n  transition: all 0.5s;\n  max-height: 100vh;\n  overflow: auto;\n"])));
...
var DownloadLink = exports.DownloadLink = _styledComponents.default.a(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  img {\n    width: 95px;\n    height: 28px;\n    object-fit: cover;\n  }\n\n  ", "\n"])), function (_ref) {
...
var ProductsRowListContainer = exports.ProductsRowListContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  margin-top: 15px;\n  overflow: auto;\n"])));
var ProductRow = exports.ProductRow = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  min-width: 600px;\n  display: flex;\n  align-items: center;\n  border-radius: 8px;\n  padding: 18px 0;\n  ", "\n"])), function (_ref2) {
...
var AppImageWrapper = exports.AppImageWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  min-width: 155px;\n  width: 18%;\n\n  > img {\n    width: 105px;\n    height: 90px;\n    object-fit: contain;\n    margin: 0 auto;\n  }\n"])));
var AppDescriptionWarpper = exports.AppDescriptionWarpper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  flex: 1;\n  padding: 0 24px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n\n  h3 {\n    font-size: 16px;\n    line-height: 24px;\n    font-weight: 500;\n    color: ", ";\n    margin: 0;\n  }\n  div {\n    font-size: 14px;\n    line-height: 24px;\n    margin: 0;\n    color: ", ";\n    display: -webkit-box;\n    -webkit-box-orient: vertical;\n    -webkit-line-clamp: 2;\n    overflow: hidden;\n  }\n\n  ", "\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
...
var AppDownloadLinksWrapper = exports.AppDownloadLinksWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 145px;\n  padding: 0 24px;\n  justify-content: center;\n\n  > a {\n    margin-top: 5px;\n    margin-bottom: 5px;\n  }\n  ", "\n\n  @media (min-width: 992px) {\n    width: 263px;\n    flex-direction: row;\n    align-items: center;\n    justify-content: initial;\n    > a {\n      &:not(:first-child) {\n        ", "\n      }\n    }\n  }\n"])), function (_ref5) {
...
var AppHeaderTitle = exports.AppHeaderTitle = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  font-weight: 700;\n  color: ", ";\n  line-height: 18px;\n"])), function (props) {
  return props.theme.colors.headingColor;
});